...
protocol-independent request payload must match after removing provider-owned
metadata and normalizing wire-equivalent output limits; and the
`provider_options` segment must differ.
